...
class Sample:
    # Constructor
    def __init__(self, dft_fname='DFT.energy', mlip_fname='MLIP.energy'):
        self.dft_fname = dft_fname
        self.mlip_fname = mlip_fname
        self.dftEnergy = read_file(dft_fname)
        self.mlipEnergy = read_file(mlip_fname)
...
plt.savefig('plot-DeltaEnergy.png', facecolor='white', bbox_inches='tight')
